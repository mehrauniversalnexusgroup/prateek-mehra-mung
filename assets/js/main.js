/* =========================================================
   ...
   Clean, lightweight & mobile-friendly
   ========================================================= */
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document
        ...
        .forEach(link => {
            ...
            link.addEventListener("click", event => {
                ...
                /*
                 * Use replaceState so the page doesn't create
    ...
    /*
     * Add animation class through JS.
     * If JS is disabled, content remains visible.
     */
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener(
            ...
            event => {
                ...
                /*
                 * Let browser validation work normally.
                 */
        ...
        /*
         * Reset after browser restores the page.
         */
        window.addEventListener(
            "pageshow",
            () => {
        ...
        () => {
            ...
            resizeTimer =
                setTimeout(() => {
                    ...
                    /*
                     * Desktop view should never keep the
                     * mobile menu state.
                     */
                    ...
                    /*
                     * Reset hero mouse transform when
    ...
    if (window.location.hash) {
        ...
        if (initialTarget) {
             ...
             * before correcting the scroll position.
             */
            setTimeout(() => {
